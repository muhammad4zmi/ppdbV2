                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    <thead>
                     ...
                     <?php
                        ...
                        $query = mysqli_query($link,"SELECT * FROM sentitems");
                            ...
                            <tr class="">
                               ...
                               <td>
                                ...
                                <td>
                                    ...
                                    echo "<a href='index.php?admin=gagal' data-toggle='tooltip' data-original-title='Kikrim Ulang'><i class='glyphicon glyphicon-refresh'></i></a>";
                                        }
                                    elseif($status=="DeliveryFailed"){
                                    echo "<a href='index.php?admin=gagal' data-toggle='tooltip' data-original-title='Kikrim Ulang'><i class='glyphicon glyphicon-refresh'></i></a>";
                                        }
                                        ...
                                        ?>
                                        <a href="index.php?admin=hapus_send&ID=<?php echo $data['ID']; ?>" title="" data-toggle="tooltip" data-original-title="Hapus Data" onclick="return confirm('Anda yakin menghapus Inbox dengan Pengirim : <?php echo $data['DestinationNumber']; ?> ?');">
