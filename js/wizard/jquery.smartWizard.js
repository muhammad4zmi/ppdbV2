...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-info")
...
// Default Properties and Events
    $.fn.smartWizard.defaults = {
        ...
        labelNext:'<i class="fa fa-chevron-circle-right"></i>  Selanjutnya  ',
        labelPrevious:'<i class="fa fa-chevron-circle-left"></i>  Sebelumnya ',
        labelFinish:'<i class="fa fa-save"></i>  Simpan  ',
